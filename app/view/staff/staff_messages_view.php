...
<div class="content1" style="background-color: white;border:none">
     ...
     <div id='dis'>
        ...
        <form method="POST">
            ...
            if (isset($_GET['toId'])) {
                echo '<tr> 
                    <td colspan="2"> <br><button name="sendMessages" value="sendMessages" formaction="?staff_sendMessages" style="padding: 10px 18px;">Send Reply Messages</button></td>
                    </tr>';
            }else{
              echo '<tr> 
                    <td colspan="2"> <br><button name="sendMessages" value="sendMessages" formaction="?staff_sendMessages" style="padding: 10px 18px;">Send Messages</button></td>
                    </tr>';
            }
            ?>
...
<table style="width: 100%; margin:1px; padding: 2px; border: 1px solid black;">
            ...
            if (isset($showAllMessages)) {
              ...
              echo  '<tr>
                ...
                <td> <a href="?staff_replyMessages&toId='.$row['TO_ACCID'].'&title='.$row['TITLE'].'">Reply</a></td>   
            </tr>';
              }
            }
