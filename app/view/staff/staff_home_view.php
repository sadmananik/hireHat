...
{
  header('Location: /HireHAT/app/view/staff/staff_home_view.php?staff_home');
  $_SESSION['count']=1;
}
...
<div class="content1"  style="background-color: white;border:none">
    <div   id="dis" style="width: 100%; margin:1px; padding: 2px;height: 100%;overflow:auto;">
            <h4 style="float: none; padding-left: 10px; color:#333">Posts</h4><br/>

<?php

$result=$_SESSION['jobArray'];
if($result!='false'){
...
echo "<div class='divFlot' style='width:900px;height:130px;margin:0 auto;background-color:#f1f1f1 '>
  ...
  <div style='width:895px;height:50px;margin:0 auto;margin-top: 5px;text-align: left;padding-left:5px'>Details<br><span>Title:$jobTitle</span><span style='margin-left:20px'> Department:$jobDepartment</span><span style='margin-left:20px'> Type: $jobType</span><br></div>
  <div class='divFlot' style='width:895px;height:30px;margin:0 auto;margin-top: 5px;text-align: left;padding:5px '><a class='aButton' href='../../controller/staff_controller.php?status=staff&AjaxView=apply&&jobId=$key'>Apply</a><a   class='aButton' style='margin-left:10px' onclick='getJobDetailsHome($key,0)'>More Details..</a></div>
</div><br>";
