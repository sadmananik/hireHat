...
<div class="content1"  style="background-color: white;border:none">
    <div   id="dis" style="width: 100%; margin:1px; padding: 2px;height: 100%;overflow:auto;">
            <h4 style="float: none; padding-left: 10px; color:#333">All Requests</h4><br/>
...
foreach($result as $key => $value) {
  ...
  $jobId=$result[$key]['JOBID'];
  $jobAppliedDate=$result[$key]['DATE'];
  
echo "<div class='divFlot' style='width:900px;height:130px;margin:0 auto;background-color:#f1f1f1 '>
  <div  style='width:895px;height:30px;margin:0 auto;margin-top: 5px;text-align: left;padding-left:5px '></div>
  <div style='width:895px;height:50px;margin:0 auto;margin-top: 5px;text-align: left;padding-left:5px'><br><span>JOBID : $jobId</span><span style='margin-left:20px'> Requested Date:$jobAppliedDate</span></div>
  <div class='divFlot' style='width:895px;height:30px;margin:0 auto;margin-top: 5px;text-align: left;padding:5px '><a class='aButton' href='../../controller/staff_controller.php?status=staff&AjaxView=requestAccept&&appliedId=$key&jobid=$jobId'>Accept</a><a   class='aButton' style='margin-left:10px' onclick= href='../../controller/staff_controller.php?status=staff&AjaxView=requestReject&&appliedId=$key'>Reject</a><a   class='aButton' style='margin-left:10px' onclick='getJobDetailsHome($jobId,1)'>More Details..</a></div>
</div><br>";
