...
<div id="box">
  ...
  <?php
    //echo "&nbsp";
    $xml=simplexml_load_file("../../../lib/xml/howItWorks.xml") or die("Error: Cannot create object");
    echo "<tr><td style='border-bottom: 1px solid gray; padding-top:8px; color: black'><h4>How It Works</h4><br/></tr></td>";
    foreach($xml->children() as $Qs) {
        
        echo "<tr><td style=''><br/>".$Qs->a ."</td></tr>";
