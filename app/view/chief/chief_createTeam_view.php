...
{
  if (isset($_SESSION['thisTeamDetails'])) {
     $thisTeamDetails=$_SESSION['thisTeamDetails'];
 ...
 <div id='dis'>
        <form method="POST">
            ...
            <br>
             <table>
             <tr>
                <td align="left">Team Name:
                     <div style="margin-top: -19px; text-align: center;" >  
                      <?php
                      if (isset($_POST['teamName'])) {

                           echo '<input style="text-align: center;" type="text" placeholder="write  n a m e" value="'.$_POST['teamName'].'"  name="teamName">';
                      }else if (isset($_SESSION['thisTeamDetails'])) {
                         echo '<input style="text-align: center;" type="text" placeholder="write  n a m e" value="'.$thisTeamDetails[0]['T_NAME'].'"  name="teamName">';
                      }
                      else
                       {
                         echo '<input style="text-align: center;" type="text" placeholder="write  n a m e" value=""  name="teamName">';
                        }
                     ?>
                      </div>
                </td>
                <td align="left">Team Description :
                     <div style="margin-top: -19px; text-align: center;" > 
                      <?php
                      if (isset($_POST['teamDetails'])) {
                            echo '<textarea name="teamDetails" rows="4" cols="20" placeholder="Write in brief about your team">'.$_POST['teamDetails'].'</textarea>';
                      }else if (isset($_SESSION['thisTeamDetails'])) {
                         echo '<textarea name="teamDetails" rows="4" cols="20" placeholder="Write in brief about your team">'.$thisTeamDetails[0]['DESCRIPTION'].'</textarea>';;
                      }else
                       {
                         echo '<textarea name="teamDetails" rows="4" cols="20" placeholder="Write in brief about your job post"></textarea>';
                        }
                     ?>           
                    </div>
                </td>
            ...
            <?php
             if (isset($_SESSION['thisTeamDetails'])) {
               echo '<tr> 
                    <td colspan="2"> <br><button name="createThisTeam" value="saveEditTeam" formaction="?chief_saveEditTeam&teamId='.$thisTeamDetails[0]['TEAMID'].'" style="padding: 10px 18px;">Save Edit</button>
                    <button name="createThisTeam" value="deleteThisTeam" formaction="?chief_deleteThisTeam&teamId='.$thisTeamDetails[0]['TEAMID'].'" style="padding: 10px 18px;">Delete Team</button></td>
                    </tr>';
             }
             else{
            ?>
            ...
            <tr>
              <td colspan="2"><button name="createThisTeam" value="createThisTeam" formaction="?chief_createThisTeam" style="padding: 10px 18px;">Create Team</button></td>
            </tr>
