...
{
  if (isset($_SESSION['showThisTeamNotice'])) {
     $showThisTeamNotice=$_SESSION['showThisTeamNotice'];
...
<div   class="content">
    <div style="width: 100%; margin:1px; padding-top: 20px; padding-bottom:10px;  border: 1px solid black; height: auto; ">
        <br>
            ...
            <br>
            <h4 style="padding-left: 10px; color:#333"><br/>All Team Notice - <?php echo $showThisTeamNotice[0]['T_NAME']; ?>  </h4><br/>
...
<table style="width: 100%; margin:1px; padding: 2px; border: 1px solid black;">
            ...
            <?php
            if (isset($showThisTeamNotice)) {
            foreach ($showThisTeamNotice as $row) {
              echo  '<tr>
                <td style="width: 8%">'.$row['TITLE'].'</td> 
                <td style="width: 8%">'.$row['NOTICE'].'</td> 
                <td style="width: 8%">'.$row['DATE'].'</td>     
                <td style="width: 8%">'.$row['TIME'].'</td>
                <td style="width: 8%"> <a href="?chief_deleteNotice&teamID='.$showThisTeamNotice[0]['TEAMID'].'&noticeId='.$row['NOTICEID'].'">Delete</a></td>    
            </tr>';
              }
            }
