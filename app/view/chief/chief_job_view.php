...
<div id='dis'>
    <div style="width: 100%; margin:1px; padding-top: 20px; padding-bottom:10px;  border: 1px solid black; height: auto; ">
        ...
        <form method="POST">
                ...
                <button name="" value="" formaction="?chief_postJob" style="padding: 10px 18px;">Post A Job Here</button>
...
<h4 style="padding-left: 10px; color:#333"><br/>All Posted Job</h4><br/>
...
<table style="width: 100%; margin:1px; padding: 2px; border: 1px solid black;">
            ...
            <tr>
                ...
                <td style="width: 8%">Salary</td>  
                <td style="width: 8%">Posted Date</td>  
                <td style="width: 8%">Last Update</td>   
                <td style="width: 7%">Total Applied</td>    
