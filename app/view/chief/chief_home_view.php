...
{
  header('Location: /HireHAT/app/view/chief/chief_home_view.php?chief_home');
  $_SESSION['count']=1;
}
?>
...
{
if (isset($_SESSION['showHighRatedStaff'])) {
     $showHighRatedStaff=$_SESSION['showHighRatedStaff'];
...
<div id='dis'>
            <br>
            <h4 style="padding-left: 10px; color:#333"><br/>High Rated Staff</h4><br/>

            <div style="overflow-y: scroll; overflow-x: hidden;  height: 415px">
...
<?php
            if (isset($showHighRatedStaff)) {
            foreach ($showHighRatedStaff as $row) {
              echo "<div class='divFlot' style='width:900px;height:130px;margin:0 auto;background-color:#f1f1f1 '>
  <div  style='width:895px;height:30px;margin:0 auto;margin-top: 5px;text-align: left;padding-left:5px '>Account Id : ".$row['ACCID']."</div>
  <div style='width:895px;height:50px;margin:0 auto;margin-top: 5px;text-align: left;padding-left:5px'>Details<br>
  <span>Name:".$row['NAME']."</span>
  <span style='margin-left:20px'> Join Date:".$row['JOINDATE']."</span> <span style='margin-left:20px'> Ratting:".$row['RATTING']."</span>
  <span style='margin-left:20px'> Mode: ".$row['MODE']."</span><br>
  </div>
  <div class='divFlot' style='width:895px;height:30px;margin:0 auto;margin-top: 5px;text-align: left;padding:5px '>
  <a class='aButton' href='?chief_hireStaff&accID=".$row['ACCID']."'>View Profile</a>
</div><br>";
              }
            }
