...
<div class="content1" style="background-color: white;border:none">
  <div id='dis'>
  <h4 style="padding-left: 10px; color:#333"><br/>All Hired Staff</h4><br/>
...
<table style="width: 100%; margin:1px; padding: 2px; border: 1px solid black;">
            ...
            if (isset($hiredStaffDetails)) {
              ...
              echo  '<tr>
                ...
                <input type="submit" formaction="?chief_rateStaff&jobId='.$row['JOBID'].'&staffId='.$row['ACCID'].'" value="Rate" name="rate">  </td> 
                <td> <a href="?chief_removeStaff&jobId='.$row['JOBID'].'&staffId='.$row['ACCID'].'">Remove Staff</a></td>    
            </tr>';
              }
            }
...
$GLOBALS['phpValidation'] ="false";
        ...
        if (!isset($_POST['RateValue'])) {
          echo '<span id="validationError">Rating Value Can not be null</span>';
        }else{
