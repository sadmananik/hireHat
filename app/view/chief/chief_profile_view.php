...
<div class="content1" style="background-color: white;border:none">
     <div id='dis'>
        ...
        <h5 style=" color:#333"><br/> Chief Profile</h5><br/>
        <table>
            <tr>
                <td style="padding-bottom: 3px;" colspan="2" align="center">
                    ...
                    echo '<span>Change Picture</span><input style="margin-left: 5px; width: 90px; color: transparent;direction: rtl;" type="file" name="file" formaction="?chief_changePicture" accept="image/*">';
                    }
                    ?>
                 ...
                 <td>
                    <?php
                     if (!isset($_POST['editProfile']) || isset($_POST['saveEdit'])) {
                         echo '<button name="editProfile" formaction="?chief_editProfile" style="padding: 10px 18px;">Edit Profile</button>';
                     }
                     else if (isset($_POST['editProfile'])) {
                        echo '<button name="saveEdit" value="saveEdit" formaction="?chief_saveEdit" style="padding: 10px 18px;">Save Edit</button>';
                    }
                    ?>                     
                 </td>    
            </tr>
