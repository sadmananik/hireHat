...
<div class="content1" style="background-color: white;border:none">
        ...
        <form id="form" action="#" method="POST">
             <button name="" value="" formaction="?chief_secendarySecurity" style="padding: 10px 18px;">Set Secendary Security</button>
            <br> <br>
        ...
        <input type="submit" formaction="?chief_submitPassword" name="submit" id="submit" value="Confirm">   
