    ...
    <header>
        <div class="divFlot">       
                ...
                <nav>
                    ...
                    <ul>
                      <li><a href="?admin_messages" class="hvr-underline-from-center">Messages</a></li>
                        <li><a href="?admin_security" class="hvr-underline-from-center1">Security</a></li>
                        <li><a href="?cadmin_profile" class="hvr-underline-from-center1">Profile</a></li>
...
<div id="ssidebar" style="background-color:#f1f1f1;border:none" >
         ...
         <nav class="navii">
             ...
             <ul>
               <div style="border: 1px solid black;"><li><a href="?admin_home" class="hvr-underline-from-center">Home</a></li></div>
               <div style="border: 1px solid black;"><li><a href="?admin_manageAccount" class="hvr-underline-from-center">Manage Account</a></li></div>
               <div style="border: 1px solid black;"><li><a href="?admin_createAdmin" class="hvr-underline-from-center">Create Account</a></li></div>
               <div style="border: 1px solid black;"><li><a href="?admin_editFAQ" class="hvr-underline-from-center">Edit FAQ</a></li></div>
               
               <div style="border: 1px solid black;"><li><a href="?admin_loginRecord" class="hvr-underline-from-center">Login Record</a></li></div>

               <div style="border: 1px solid black; border-bottom: 2px solid black;"><li><a href="?admin_postNews" class="hvr-underline-from-center">Post News</a></li></div>
            </ul>
         </nav>
...
<div class="content1" style="background-color: white;border:none">
        ...
        <form id="form" action="#" method="POST">
            ...
            <input type="submit" formaction="?admin_submitCode" name="submit" id="submit" value="Confirm">   
